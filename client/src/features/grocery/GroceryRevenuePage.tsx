...
import type { PartnerGroceryRevenue } from "./types";

export function GroceryRevenuePage() {
  const revenue = useResource<PartnerGroceryRevenue>(() => api.get(endpoints.grocery.partner.revenue), []);
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Revenue" subtitle="Daily earnings, platform fees, and refunds across your stores." />
