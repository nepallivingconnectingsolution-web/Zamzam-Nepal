...
/** "3m ago" / "2h ago" / "5d ago" — no date library needed for this. */
...
export function NotificationBell() {
  ...
  const feed = useResource<NotificationsResponse>(
    () => saApi<NotificationsResponse>("/super-admin/notifications?limit=8"),
    [],
    { refreshInterval: POLL_MS },
  );

  // Pop a toast for any notification that shows up after the very first
  // load — i.e. genuinely new activity, not the backlog that already
  // existed when the dashboard was opened.
  useEffect(() => {
          ...
          >
              ...
              {feed.state === "loading" || feed.state === "idle" ? (
                ...
                <div className="flex flex-col items-center gap-2 px-6 py-10 text-center">
                  ...
                  <p className="text-xs text-muted-fg">
                    New partner and business activity will show up here.
                  </p>
                </div>
              ) : (
                      ...
                      <li key={n.id}>
                        ...
                        >
                          ...
                          <span className="min-w-0 flex-1">
                            ...
                            <span className="mt-1 block text-[11px] text-muted-fg/70">
                              {timeAgo(n.createdAt)}
                            </span>
                          </span>
                        </button>
            ...
            <div className="border-t border-border p-2">
              <Button
                ...
                onClick={() => {
                  setOpen(false);
                  navigate("/x-admin/notifications");
                }}
              >
                View all
              </Button>
